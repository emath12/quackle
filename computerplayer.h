...
struct ComputerParameters {
  ...
  // when simming, use likely rack leaves for opponent based on their previous
  // play
  bool inferring;
...
inline void
ComputerPlayer::setParameters(const ComputerParameters &parameters) {
...
inline const UVString &ComputerPlayer::name() const { return m_name; }

inline int ComputerPlayer::id() const { return m_id; }

inline bool ComputerPlayer::isSlow() const { return false; }

inline bool ComputerPlayer::isUserVisible() const { return false; }

inline ComputerDispatch *ComputerPlayer::dispatch() const { return m_dispatch; }

inline double ComputerPlayer::max(double v1, double v2) {
  return v1 > v2 ? v1 : v2;
}

inline int ComputerPlayer::max(int v1, int v2) { return v1 > v2 ? v1 : v2; }
