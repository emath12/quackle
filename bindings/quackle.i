...
#include <QString>
    ...
    % include "std_string.i" % include "std_vector.i" % include "typemaps.i"

    % include "fixedstring.h" % include "uv.h" %
    include "alphabetparameters.h"
...
% include "move.h" % include "rack.h" % include "bag.h" % include "board.h" %
    include "boardparameters.h" % include "evaluator.h" % include "catchall.h" %
    include "player.h"
...
% include "game.h" % include "gameparameters.h" % include "sim.h" %
    include "computerplayer.h" % include "computerplayercollection.h"
...
% include "datamanager.h" % include "endgame.h" % include "endgameplayer.h" %
    include "boarddrivenplayer.h" % include "enumerator.h" %
    include "bogowinplayer.h" % include "clock.h" % include "generator.h" %
    include "gaddag.h" % include "lexiconparameters.h" %
    include "preendgame.h" % include "reporter.h" % include "resolvent.h" %
    include "strategyparameters.h"

    % include<QString> % include "quackleio/flexiblealphabet.h" %
    include "quackleio/util.h" % include "quackleio/logania.h" %
    include "quackleio/gcgio.h"
